    ...
    <![endif]-->
      <!-- .page-navbar -->
        <div id="header" class="page-navbar">
            <!-- .navbar-brand -->
            <a href="<?php echo base_url('Bootstrap/Bootstrap/admin-html/'); ?>index.html" class="navbar-brand hidden-xs hidden-sm">
                <img src="<?php echo base_url('Bootstrap/Bootstrap/admin-html/'); ?>img/logo.png" class="logo hidden-xs" alt="Dynamic logo">
                <img src="<?php echo base_url('Bootstrap/Bootstrap/admin-html/'); ?>img/logosm.png" class="logo-sm hidden-lg hidden-md" alt="Dynamic logo">
            </a>
            <!-- / navbar-brand -->
            <!-- .no-collapse -->
            <div id="navbar-no-collapse" class="navbar-no-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="<?php echo base_url('Bootstrap/Bootstrap/admin-html/'); ?>login.html">
            ...
            <aside id="sidebar" class="page-sidebar hidden-md hidden-sm hidden-xs">
                ...
                <div class="sidebar-inner">
                    ...
                    <div class="sidebar-scrollarea">
                        ...
                        <div class="side-nav">
                            <ul class="nav">
                                <li><a href="<?php echo base_url('pendaftaran'); ?>"><i class="l-basic-laptop"></i><span class="txt">Dashboard</span></a>
                                </li>
                                ...
                                <li>
                                    <a href="#"><i class="l-basic-webpage-txt"></i><span class="txt">Form Pendaftaran</span></a>
                                    <ul class="sub">
                                        <li><a href="<?php echo base_url('Form-Pendaftaran'); ?>"><span class="txt">Form FST</span></a>
                                        </li>
